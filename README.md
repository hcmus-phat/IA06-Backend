...
## Notes
- Passwords should be hashed before saving. Current `register` stores plain text and `login` uses `bcrypt.compare`, which requires hashed passwords. Update `register` to hash:
  ```
